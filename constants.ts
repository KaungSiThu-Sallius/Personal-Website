...
export const BLOG_POSTS: BlogPost[] = [
  ...
  {
    id: 2,
    title: "How I Built a Resume Scanner Using Python and Streamlit",
    excerpt: "In a hiring landscape relying on 'gut feeling,' we often overlook the mathematical rigor required to build an objective ranking engine that turns the chaos of unstructured PDFs into precise, vector-based candidate insights.",
    date: "Feb 4, 2026",
    readTime: "4 min read",
